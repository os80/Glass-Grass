...
void setPlayerCoordinateForView(int x, int y) { //функция для считывания координат игрока
	int tempX = x; int tempY = y;//считываем коорд игрока и проверяем их, чтобы убрать края
